export const condFieldName = (name: string): any => (_: any, e: any) =>
  e.fieldName === name;

export const condIsEnabled = (name: string): any => (
  _c: any,
  _e: any,
  m: any
) => {
...
export const condIsVisible = (name: string): any => (
  _c: any,
  _e: any,
  m: any
 ...
 * @param conditions
 */
export const conditionsAll = (conditions: any[]): any => (
  c: any,
  e: any,
  m: any
